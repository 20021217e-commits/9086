...
#define SUBCODE_WARE_BLK					(0xB3)	//20180309 WareBlk With Specific Data
#define SUBCODE_RESUME	  					(0xB4)	//20180309 ERS&PGM operation Resume
#define SUBCODE_I2C_SET_VAL                 (0xB5)  //20190213 set value to a register of a specific I2C device
#define SUBCODE_I2C_GET_VAL                 (0xB6)  //20190213 get value from a register of a specific I2C device
#define SUBCODE_POWER_SWITCH                (0xB7)  //20190213 flash IO/Core power switch
#define SUBCODE_READ_ADC                    (0xB8)  //20190214 read ADC value
#define SUBCODE_RW_CACHE                    (0xB9)  //20200305 Wrte/Read Cache With Current Sampling
...
#define SUBCODE_8T23_RETRY 					(0xC4)
...
#define SUBCODE_HAL_SetFCParam				(0xC9)
#define SUBCODE_UNIVERSAL					(0xCA)
#define SUBCODE_Hynix3DV4_ReadPage			(0xCB)
#define SUBCODE_Hynix3DV4_Retry				(0xCC)
#define SUBCODE_FDL_CHECK_BLK_DATA			(0xCD)
#define SUBCODE_FDL_READ_ID					(0xCE)
#define SUBCODE_FDL_WriteCache				(0xCF)
