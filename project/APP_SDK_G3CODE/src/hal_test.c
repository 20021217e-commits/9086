...
*/
		...
		else if((PageAddr>=5124)&&(PageAddr<5136))
		{
			*WLAddr = (PageAddr - 1704) / 2;
			*PageIndex = (PageAddr - 5124) % 2 + 1;
		}
		else if(PageAddr>=5136)
		{
			*WLAddr = PageAddr - 3420;
			*PageIndex = 2;
		}
		else//PageAddr>=12 && PageAddr<5124
		{
			*WLAddr = (PageAddr + 6) / 3;
			*PageIndex = (PageAddr + 6) % 3;
		}
...
void MultiPlane_WritePage_SAMSUNG(T_FDL_FTCTRL *pCtrl, U32 WLAddress, U32 PageAddress, U32 PageOrder)
{
	...
	{
		if((PageAddress < 12 && PageOrder == 1) ||
			(PageAddress >= 5124 && PageAddress < 5136 &&PageOrder == 1))
			{
				Samsung_MultiPlane_WriteDummyPage(BlkIdx, BlkList, pCtrl->dPlaneCnt, bChan,bChip);
			}
	}
	...
	if ((1 == pCtrl->dMode))
	{
		...
		else if(2 == PageOrder)//MSB
		{
            ...
            #if ((NAND_FLASH == SAMSUNG_3DV6P)||(NAND_FLASH == SAMSUNG_3DV6_TLC)||(NAND_FLASH == SAMSUNG_3DV8_TLC)||(NAND_FLASH == SAMSUNG_3DV9_TLC)||(NAND_FLASH == SAMSUNG_3DV7_TLC))
            {
...
#if	  ((NAND_FLASH == SanDisk_BiCS5_TLC))
            if(1==pCtrl->dMode)
            {
                PreCMD = PageAddress%3 + 1;
                WlAddr = (PageAddress/3);
...
void FA_WriteBlk(void)
{
    ...
    #elif ((NAND_FLASH == SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH==SanDisk_BiCS5_TLC))
		U16 PgmInfo[2];
		if (0==pCtrl->dMode)
		{
			PgmCnt=FDL_SLC_PAGE_OF_BLK;
...
#if ((NAND_FLASH == SAMSUNG_3DV9_TLC))
	if((1 == pCtrl->dMode))
	{
		GetWLAndPage( PageAdd, &WLAddress, &PageOrder);
		if((PageAdd < 12 && PageAdd%2 == 0) ||(PageAdd >= 5124 && PageAdd < 5136 && PageAdd%2 == 0))
		Samsung_MultiPlane_WriteDummyPage(BlkIdx, BlkList, pCtrl->dPlaneCnt, bChan,bChip);
	}
#endif
...
#if((NAND_FLASH == SAMSUNG_3DV6_TLC)||(NAND_FLASH == SAMSUNG_3DV7_TLC)||(NAND_FLASH == SAMSUNG_3DV8_TLC)||(NAND_FLASH == SAMSUNG_3DV9_TLC)||(NAND_FLASH == SAMSUNG_3DV6P))
        HAL_CQSendFlashCmd(bChan, FL_CMD_PAGE_PROG1_MP);
#else
		HAL_CQSendFlashCmd(bChan, FL_CMD_PAGE_PROG1);
#endif
...
#elif((NAND_FLASH == SAMSUNG_3DV6_TLC)||(NAND_FLASH == SAMSUNG_3DV7_TLC)||(NAND_FLASH == SAMSUNG_3DV8_TLC)||(NAND_FLASH == SAMSUNG_3DV9_TLC)||(NAND_FLASH == SAMSUNG_3DV6P))
	if ((1 == pCtrl->dMode))
	{
		HAL_CQSendFlashCmd(bChan, FL_CMD_ED3_PAGE_PROG);
		//2Plane Flash:0x31,0x32,0x33;4Plane Flash:0xF1,0xF2,0xF3
...
#if	  ((NAND_FLASH == Hynix_3DV6_TLC)||(NAND_FLASH == Hynix_3DV7_TLC)||(NAND_FLASH == Hynix_3DV5_TLC)||(NAND_FLASH == Hynix_3DV8_TLC)||(NAND_FLASH == Hynix_3DV9_TLC)||(NAND_FLASH == SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH==SanDisk_BiCS5_TLC))
	if(0==pCtrl->dMode)
	{
		ConfirmCMD = pCtrl->P4;
	}
...
{
#if ((NAND_FLASH==Hynix_3DV6_TLC)||(NAND_FLASH == Hynix_3DV7_TLC)||(NAND_FLASH == Hynix_3DV5_TLC)||(NAND_FLASH == Hynix_3DV7_QLC)||(NAND_FLASH == SanDisk_BiCS5_QLC)||(NAND_FLASH == SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH==SanDisk_BiCS5_TLC)||(NAND_FLASH == MIC_B58R)||(NAND_FLASH == MIC_N58R)||(NAND_FLASH == MIC_N69R)||(NAND_FLASH == MIC_B57T)||(NAND_FLASH == Hynix_3DV8_TLC)||(NAND_FLASH == Hynix_3DV9_TLC)||(NAND_FLASH == SanDisk_BiCS6_QLC)||(NAND_FLASH==SanDisk_BiCS8_QLC))
	FA_WritePage_PreCMD();
#elif ((NAND_FLASH==SAMSUNG_3DV5_2K_MLC))
    FA_WritePage_V5_MLC();
#else
...
#if	  ((NAND_FLASH == Hynix_3DV6_TLC)||(NAND_FLASH == Hynix_3DV7_TLC)||(NAND_FLASH == Hynix_3DV5_TLC)||(NAND_FLASH == Hynix_3DV8_TLC)||(NAND_FLASH == Hynix_3DV9_TLC)||(NAND_FLASH==SanDisk_BiCS5_TLC))
	if(1==pCtrl->dMode)
	{
		PreCMD = PageAdd%3 + 1;
		WlAddr = PageAdd/3;
...
#if ((NAND_FLASH == TOSHIBA_FLASH)||(NAND_FLASH == SanDisk_BiCS5_QLC)||(NAND_FLASH == SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH == SanDisk_BiCS6_QLC)||(NAND_FLASH==SanDisk_BiCS8_QLC)||(NAND_FLASH==SanDisk_BiCS5_TLC)) ///需要retry使能指令的flash类型
        bRetry_En = TRUE;
#else
        bRetry_En = FALSE;
#endif
...
void FA_ReadData(void)
{
	...
	SG_DMA2_CH(bChan)->rLEN_CFG.bits.BASIC_DATA_LEN = 2*512;
		...
		SG_FC(bChan)->rNF_CFG.bits.FLASH_MODE = 0x00;
		SG_FC(bChan)->rCONFIG_SPI.bits.CPOL = 0;
    #else
		SG_FC(bChan)->rNF_CFG.bits.FLASH_MODE = 0x02;
	#endif

#if((NAND_FLASH==Hynix_3DV6_TLC)||(NAND_FLASH == Hynix_3DV7_TLC)||(NAND_FLASH == Hynix_3DV5_TLC)||(NAND_FLASH == Hynix_3DV7_QLC)||(NAND_FLASH == SanDisk_BiCS5_QLC)||(NAND_FLASH == SanDisk_BiCS6_TLC)||(NAND_FLASH == SanDisk_BiCS5_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH == MIC_B57T)||(NAND_FLASH == MIC_B58R)||(NAND_FLASH == MIC_N58R)||(NAND_FLASH == MIC_N69R)||(NAND_FLASH == Hynix_3DV8_TLC)||(NAND_FLASH == Hynix_3DV9_TLC)||(NAND_FLASH == SanDisk_BiCS6_QLC)||(NAND_FLASH==SanDisk_BiCS8_QLC))
	...
	SG_CPM->rSYS_CLK_SWITCH_EN = 1;
	SG_FC(bChan)->rNF_CFG.bits.FLASH_MODE = 0x02;
	SG_FC(bChan)->rCONFIG_SPI.bits.CPOL = 1;
}
...
#elif((NAND_FLASH==SAMSUNG_3DV6_TLC)||(NAND_FLASH==SAMSUNG_3DV8_TLC)||(NAND_FLASH==SAMSUNG_3DV9_TLC)||(NAND_FLASH==SAMSUNG_3DV6P)||(NAND_FLASH==SAMSUNG_3DV7_TLC)||(NAND_FLASH==SAMSUNG_3DV5_QLC)||(NAND_FLASH==SAMSUNG_3DV4_QLC)||(NAND_FLASH==SAMSUNG_3DV7_QLC)||(NAND_FLASH==SAMSUNG_3DV5_2K_MLC))
	HAL_CQSendFlashCmd(bChan,0xDA);
...
#if ((NAND_FLASH == TOSHIBA_FLASH)||(NAND_FLASH == KHMB)||(NAND_FLASH == SanDisk_BiCS5_QLC)||(NAND_FLASH == SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH==SanDisk_BiCS5_TLC)||(NAND_FLASH == SanDisk_BiCS6_QLC)||(NAND_FLASH==SanDisk_BiCS8_QLC)) ///需要retry使能指令的flash类型
	bRetry_En = TRUE;
#else
	bRetry_En = FALSE;
#endif
...
void FA_SetOffset(void)
{
...
#elif((NAND_FLASH == SAMSUNG_3DV6_TLC)||(NAND_FLASH == SAMSUNG_3DV7_TLC)||(NAND_FLASH == SAMSUNG_3DV8_TLC)||(NAND_FLASH == SAMSUNG_3DV9_TLC))
	U8 idata[4] = {offset,offset,offset,offset};
	HAL_CQWaitDone(bChan);
	HAL_MCU_SetCe(bChan,bChip,1);
	U8 addr;
	...
	Delay(4);
	HAL_MCUSendNByteDataByDqs(bChan,ydata,4);
#elif ((NAND_FLASH == SanDisk_BiCS8_TLC)||(NAND_FLASH == SanDisk_BiCS5_TLC))
	U8 ydata[4] = {offset,offset,offset,offset};
	HAL_CQWaitDone(bChan);
	HAL_MCU_SetCe(bChan,bChip,1);
...
#if ((NAND_FLASH==Hynix_3DV6_TLC)||(NAND_FLASH==Hynix_3DV7_TLC)||(NAND_FLASH==Hynix_3DV8_TLC)||(NAND_FLASH==Hynix_3DV9_TLC)||(NAND_FLASH==SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(NAND_FLASH==SanDisk_BiCS5_TLC)||(NAND_FLASH==YMTC_X2_9060)||(NAND_FLASH==YMTC_X3_9060)||(NAND_FLASH==YMTC_X4_9060))
	U8 	PreCMD;
...
void FA_ReadDisturb(void)
{
	...
	/*
	 * WlAddr == 65535 表示从上一次记录的 WL 继续执行。
	 * 否则从指定 WlAddr 开始执行。
	 */
	U16 WL = (WlAddr == 65535) ? *WLInLastRound : WlAddr;
	...
	while (1)
	{
		 ...
		 *
		 * PageTpye == 0:
		 *     保持原逻辑，遍历当前 WL 下 GroupModel[WL * 4 + 0 ~ 3] 中有效项。
		 *
		 * PageTpye == 1 / 2 / 3:
		 *     只执行指定 page type。
		 *     PageTpye == 1 -> 使用 GroupModel[WL * 4 + 0]
		 *     PageTpye == 2 -> 使用 GroupModel[WL * 4 + 1]
		 *     PageTpye == 3 -> 使用 GroupModel[WL * 4 + 2]
		 *
		 * 其他值:
		 *     退出函数主循环，避免无效空跑。
		 */
...
#if ((NAND_FLASH == Hynix_3DV6_TLC) || \
	 (NAND_FLASH == Hynix_3DV7_TLC) || \
	 (NAND_FLASH == Hynix_3DV5_TLC) || \
	 (NAND_FLASH == Hynix_3DV7_QLC) || \
	 (NAND_FLASH == SanDisk_BiCS5_QLC) || \
	 (NAND_FLASH == SanDisk_BiCS6_TLC) || \
	 (NAND_FLASH == SanDisk_BiCS5_TLC) || \
	 (NAND_FLASH == SanDisk_BiCS8_TLC) || \
	 (NAND_FLASH == MIC_B57T) || \
	 (NAND_FLASH == MIC_B58R) || \
	 (NAND_FLASH == MIC_N58R) || \
	 (NAND_FLASH == Hynix_3DV8_TLC) || \
	 (NAND_FLASH == SanDisk_BiCS6_QLC))
			 ...
			 * PreCMD 类型 NAND：
			 * RowAddr 使用 WL。
			 * j = 0 / 1 / 2 / 3 时，发送的 page type cmd 为 1 / 2 / 3 / 4。
			 */
			U32 dRowAdd = BlkAdd * FDL_ROW_OF_BLK + WL;

			for (j = 0; j < 4; ++j)
			{
				if (GroupModel[WL * 4 + j] == 65535)
				{
					break;
				}
			...
			/*
			 * condition2: without PreCMD
			 *
			 * without PreCMD 类型 NAND：
			 * RowAddr 使用 GroupModel[WL * 4 + j]。
			 */
			for (j = 0; j < 4; ++j)
			{
				if (GroupModel[WL * 4 + j] == 65535)
				...
				U32 dRowAdd = BlkAdd * FDL_ROW_OF_BLK + GroupModel[WL * 4 + j];

				//FDL_Log("time=%d,Page=%d", dReadTime, GroupModel[WL * 4 + j]);
		...
		else if ((PageTpye == 1) || (PageTpye == 2) || (PageTpye == 3))
		{
			/*
			 * PageTpye == 1 / 2 / 3:
			 * 只执行指定 page type。
			...
			/*
			 * 如果对应 GroupModel 项无效，则本轮 WL 不执行 read disturb。
			 */
			if (GroupModel[WL * 4 + j] != 65535)
			{
	 ...
	 (NAND_FLASH == SanDisk_BiCS6_QLC))
				 ...
				 *
				 * 当 PageTpye == 3 时：
				 *     HAL_CQSendFlashCmd(bChan, 0x03);
				 *     HAL_CQSendFlashCmd(bChan, 0x00);
				 *     SendAddr(row = BlkAdd * FDL_ROW_OF_BLK + WL);
				 *     HAL_CQSendFlashCmd(bChan, 0x30);
				 */
				U32 dRowAdd = BlkAdd * FDL_ROW_OF_BLK + WL;
				...
				HAL_CQSendFlashCmd(bChan, PageTpye);
				 ...
				 * condition2: without PreCMD
				 *
				 * PageTpye == 1 / 2 / 3 时，只读取：
				 *     GroupModel[WL * 4 + PageTpye - 1]
				 */
				U32 dRowAdd = BlkAdd * FDL_ROW_OF_BLK + GroupModel[WL * 4 + j];
		...
		else
		{
			 ...
			 * 有需要可打开 Log。
			 */
			//FDL_Log("Invalid PageTpye=%d", PageTpye);
			break;
		}
	...
	*WLInLastRound = WL;
	...
	//FDL_Log("[1]WLInLastRound=%d", *WLInLastRound);
...
void FA_FindOV_Init(void)
{
	...
	*ofsStartIdx 	= *xLC==1? 0 : *xLC==2? 1 : *xLC==3? 4 : 11;
	...
	for (pageIdx = 0, gVRIdx = 0; pageIdx < *xLC; pageIdx++)
	{
		...
		vReadStartIdx[pageIdx]	= pageIdx==0?0:(vReadCnt[pageIdx-1]+vReadStartIdx[pageIdx-1]);
...
void DataMove(U8 bChan, U8 bChip, U32 dBlkAddr, U32 dPageAddr, U32 dBuffAddr) //将页数据移动到指定内存地址
{
...
#if((NAND_FLASH == Hynix_3DV8_TLC)||(NAND_FLASH == SanDisk_BiCS5_TLC))
	...
	HAL_CQCheckIOStatus(bChan, bChip, IO_1_PASS, FIO_STAT_READY, FIO_STAT_PASS);
	HAL_CQSendRndAddr(bChan, 0, dRowAddr);
#elif((NAND_FLASH == SAMSUNG_3DV7_TLC)||(NAND_FLASH == SAMSUNG_3DV8_TLC)||(NAND_FLASH == SAMSUNG_3DV9_TLC))
	dRowAddr = dBlkAddr * FDL_ROW_OF_BLK + dPageAddr;
	HAL_CQSetRndSeed(bChan, dPageAddr, 0); //种子设定
	HAL_CQSendFlashCmd(bChan, FL_CMD_READ1);
	HAL_CQSend6Addr(bChan, 0, dRowAddr);
...
#if ((FDL_TEST_FLASH==SanDisk_BiCS5_QLC)||(FDL_TEST_FLASH==SanDisk_BiCS6_TLC)||(NAND_FLASH==SanDisk_BiCS8_TLC)||(FDL_TEST_FLASH==SanDisk_BiCS6_QLC)||(FDL_TEST_FLASH==SanDisk_BiCS8_QLC)||(FDL_TEST_FLASH==KHMB)||(FDL_TEST_FLASH==SanDisk_BiCS5_TLC))
    HAL_FA_DQSSetParameter(bChan, bChip, Add, Param, PreCmdOption, SetCmd);
#elif ((FDL_TEST_FLASH==Hynix_3DV6_TLC)||(NAND_FLASH == Hynix_3DV7_TLC)||(NAND_FLASH == Hynix_3DV5_TLC)||(NAND_FLASH == Hynix_3DV7_QLC)||(NAND_FLASH == Hynix_3DV8_TLC)||(NAND_FLASH == Hynix_3DV9_TLC))
	HAL_CQSendFlashCmd(bChan,0x36);
